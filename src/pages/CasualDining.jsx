...
import rings from "../assets/Dining/rings.jpg";
import pasta from "../assets/Dining/main3.jpg";
import pazta from "../assets/Dining/main5.jpg";
import Bru from "../assets/Dining/start1.jpg";
import meat1 from "../assets/Dining/meat.jpg";
import meat2 from "../assets/Dining/main2.jpg";
import meat3 from "../assets/Dining/main6.jpg";
...
const menuItems = [
  ...
  },
  {
    ...
    price: 13.99,
    popular: false,
    description: 'Tender squid rings in crispy coating, served with marinara and aioli',
...
const sidesItems = [
  {
    ...
    price: 28.99,
    popular: true,
    description: 'House-made ravioli filled with lobster and ricotta in creamy tomato sauce',
    chef: 'Chef Antonio Rivera',
  },
  {
    image: pazta,
...
const menuCategories = [
  {
    ...
    description: 'Thoughtfully prepared dishes perfect for sharing with family and friends',
    dishes: 7, // Updated to match Appetizers (2), Main Courses (3), Pasta & Risotto (2)
    priceRange: '$11.99 - $32.99', // Updated to match new item prices
  },
];
  ...
  return (
    <div className="bg-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-10">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-800">Casual Dining Menu</h2>
        <p className="mt-2 text-gray-600">Thoughtfully prepared dishes perfect for sharing with family and friends</p>
      </div>
...
const AppetizersAndStarters = () => {
  return (
    <div className="bg-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-10">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-800">Appetizers & Starters</h2>
      </div>
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
...
const MainCourses = () => {
  return (
    <div className="bg-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-10">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-800">Main Courses</h2>
      </div>
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
...
const PastaAndRisotto = () => {
  return (
    <div className="bg-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-10">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-800">Pasta & Risotto</h2>
      </div>
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
    ...
    <div className="bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-10">
        ...
        <p className="mt-2 text-gray-600">
          Thoughtfully prepared dishes perfect for sharing with family and friends
        </p>
      </div>
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
  ...
  return (
    <div className="bg-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-800">Why Choose Casual Dining?</h2>
        <p className="mt-2 text-gray-600">
          Experience the perfect balance of quality, comfort, and convenience
        </p>
  ...
  return (
    <div className="bg-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto text-center p-8 rounded-lg shadow-md bg-green-50">
        <h2 className="text-3xl font-bold text-gray-800">Craving Restaurant Quality?</h2>
